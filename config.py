...
API_ID = int(os.environ.get("API_ID", "11688980"))
API_HASH = os.environ.get("API_HASH", "d834d7345d9d61329af39c6bc7a8ef46")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5956361949:AAH07WqDrfImAlz9iE-IbNZZMiFJ8XlSQik")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "9Aa6DyB4941UU0nbLsSf")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001894857215")) if os.environ.get("CHANNEL_ID") else []
...
USERNAME = os.environ.get("USERNAME", "moviesserchz")
